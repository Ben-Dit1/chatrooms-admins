...
const CreateSessionModal = ({ closeModal }: CreateSessionModalProps) => {
  return (
    <div
      onClick={() => {
        closeModal();
    ...
    >
      ...
      >
        <p className="text-2xl text-slate-100">Enter New Session</p>
        <input
          type="text"
        ...
        />
        <Dropdown organizations={organizations} />
